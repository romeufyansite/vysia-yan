...
export function ConnectScreenStepHeader({
  ...
  return (
    <header className={cn('mb-8 text-center', className)}>
      <p className="mb-2 text-xs font-medium uppercase tracking-[0.2em] text-violet-600/90">
        Étape {step}
      </p>
      <h3 className="text-balance text-xl font-medium tracking-tight text-slate-900 sm:text-2xl">
        {title}
      </h3>
